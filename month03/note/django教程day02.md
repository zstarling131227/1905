...
- MVC 设计模式
    ...
    - MVC模式如图:
        ![](/home/tarena/1905/month03/code/code3/day02/day02_note/day02_note/images/mvc.png)
...
- MTV 模式
    ...
    - MTV模式如图:
        ![](/home/tarena/1905/month03/code/code3/day02/day02_note/day02_note/images/mtv.png)
...
4. if 标签里的布尔运算符
    - if 条件表达式里可以用的运算符 ==, !=, <, >, <=, >=, in, not in, is, is not, not、and、or。不能使用加减乘除运算符。
...
5. locals函数
    ...
    以上fx函数中有3个局部变量。locals函数将局部变量返回字典的形式。
...
- 模板的继承示例:
    ...
    - ![](/home/tarena/1905/month03/code/code3/day02/day02_note/day02_note/images/template_inherit.png)
