...
class StudentManagerController:
    ...
    def order_by_order(self):########修改部分(补充)
        """
        根据成绩,对self._stu_list进行升序排列
        :return:
        """
...
class StudentManagerView:
    ...
    def __select_menu(self):
        ...
        if item == "1":
            ...
            self.__output_syudent_by_score(self)
    ...
    def _output_syudent_by_score(self):########修改部分(补充)
        self.__manager.order_by_order()
        self.__output_syudent(self.__manager.stu_list)
